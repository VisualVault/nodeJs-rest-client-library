# TC-4-D-noz-IST — Config D, URL Parameter, IST: Config D without Z in IST; Bug #5
...
| **Scenario**            | URL param `Field5=2026-03-15T14:30:00`, IST                                                                     |
...
- Interpretation: Config D without Z in IST. Correct local storage. Fake Z on API (Bug #5).
...
| Reference              | Location                                                          |
| ---------------------- | ----------------------------------------------------------------- |
| Matrix row             | `matrix.md` — row `4-D-noz-IST`                                   |
| Run history            | [`summaries/tc-4-D-noz-IST.md`](../summaries/tc-4-D-noz-IST.md)   |
| Latest run             | [`runs/tc-4-D-noz-IST-run-1.md`](../runs/tc-4-D-noz-IST-run-1.md) |
