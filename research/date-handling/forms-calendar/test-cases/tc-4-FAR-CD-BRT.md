# TC-4-FAR-CD-BRT — FillinRelate C→D, BRT: C→D BRT: Accidentally correct! Source C returns "2026-03-15T03:00:00
...
| 6   | Capture target raw value                                     | `VV.Form.VV.FormPartition.getValueObjectValue('Field5')`                                                                                                                                                                                       | `"2026-03-15T00:00:00"`      | ☐   |
| 7   | Capture target API value                                     | `VV.Form.GetFieldValue('Field5')`                                                                                                                                                                                                              | `"2026-03-15T00:00:00.000Z"` | ☐   |
...
**FAIL-2 (Target raw mismatch):** Step 6 returns a value different from `"2026-03-15T00:00:00"`.

- Bugs exercised: none
- Interpretation: C→D BRT: Accidentally correct! Source C returns "2026-03-15T03:00:00.000Z" (real UTC, BRT midnight). Target D strips Z → "...T03:00:00.000" → new Date() parses as UTC 03:00 (thanks to .000) → BRT local midnight. Value survives because UTC→local conversion recovers the original time.
...
| Reference               | Location                                                            |
| ----------------------- | ------------------------------------------------------------------- |
| Matrix row              | `matrix.md` — row `4-FAR-CD-BRT`                                    |
| Run history             | [`summaries/tc-4-FAR-CD-BRT.md`](../summaries/tc-4-FAR-CD-BRT.md)   |
| Latest run              | [`runs/tc-4-FAR-CD-BRT-run-1.md`](../runs/tc-4-FAR-CD-BRT-run-1.md) |
