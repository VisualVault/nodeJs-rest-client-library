# TC-4-C-noz-IST — Config C, URL Parameter, IST: Config C without Z in IST
...
| **Scenario**            | URL param `Field6=2026-03-15T14:30:00`, IST                                                                      |
...
| 3   | Capture GetFieldValue return (DevTools console) | `VV.Form.GetFieldValue('Field6')`                        | `"2026-03-15T09:00:00.000Z"`                     | ☐   |
...
- Bugs exercised: none
- Interpretation: Config C without Z in IST. Local 14:30 IST stored. API returns UTC equivalent (-5:30h).

**FAIL-2 (Wrong API value):** Step 3 returns a value different from `"2026-03-15T09:00:00.000Z"`.
...
| Reference              | Location                                                          |
| ---------------------- | ----------------------------------------------------------------- |
| Matrix row             | `matrix.md` — row `4-C-noz-IST`                                   |
| Run history            | [`summaries/tc-4-C-noz-IST.md`](../summaries/tc-4-C-noz-IST.md)   |
| Latest run             | [`runs/tc-4-C-noz-IST-run-1.md`](../runs/tc-4-C-noz-IST-run-1.md) |
