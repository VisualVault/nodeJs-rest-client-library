# TC-4-C-z-IST — Config C, URL Parameter, IST: Config C with Z in IST; Bug #1
...
| **Scenario**            | URL param `Field6=2026-03-15T14:30:00.000Z`, IST                                                                 |
...
| 2   | Capture raw stored value (DevTools console)     | `VV.Form.VV.FormPartition.getValueObjectValue('Field6')` | `"2026-03-15T20:00:00"`                          | ☐   |
...
- Interpretation: Config C with Z in IST. Raw shifts +5:30h (Z stripped, re-parsed as local, then stored as IST local). API recovers correct UTC.
...
| Reference              | Location                                                      |
| ---------------------- | ------------------------------------------------------------- |
| Matrix row             | `matrix.md` — row `4-C-z-IST`                                 |
| Run history            | [`summaries/tc-4-C-z-IST.md`](../summaries/tc-4-C-z-IST.md)   |
| Latest run             | [`runs/tc-4-C-z-IST-run-1.md`](../runs/tc-4-C-z-IST-run-1.md) |
