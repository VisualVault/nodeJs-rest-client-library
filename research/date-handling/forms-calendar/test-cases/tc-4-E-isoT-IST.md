# TC-4-E-isoT-IST — Config E, URL Parameter, IST: Legacy date-only in IST
...
| **Scenario**            | URL param `Field12=2026-03-15T00:00:00`, IST                                                                     |
...
- Bugs exercised: none
- Interpretation: Legacy date-only in IST. Correct — no FORM-BUG-7. Legacy display empty but value stored.
...
| Reference              | Location                                                            |
| ---------------------- | ------------------------------------------------------------------- |
| Matrix row             | `matrix.md` — row `4-E-isoT-IST`                                    |
| Run history            | [`summaries/tc-4-E-isoT-IST.md`](../summaries/tc-4-E-isoT-IST.md)   |
| Latest run             | [`runs/tc-4-E-isoT-IST-run-1.md`](../runs/tc-4-E-isoT-IST-run-1.md) |
