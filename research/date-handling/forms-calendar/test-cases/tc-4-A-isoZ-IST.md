# TC-4-A-isoZ-IST — Config A, URL Parameter, IST: Date-only with Z suffix in IST
...
| **Scenario**            | URL param `Field7=2026-03-15T00:00:00.000Z`, IST                                                                  |
...
- Bugs exercised: none
- Interpretation: Date-only with Z suffix in IST. Z stripped by T-truncation, date correct.
...
| Reference              | Location                                                            |
| ---------------------- | ------------------------------------------------------------------- |
| Matrix row             | `matrix.md` — row `4-A-isoZ-IST`                                    |
| Run history            | [`summaries/tc-4-A-isoZ-IST.md`](../summaries/tc-4-A-isoZ-IST.md)   |
| Latest run             | [`runs/tc-4-A-isoZ-IST-run-1.md`](../runs/tc-4-A-isoZ-IST-run-1.md) |
