# TC-4-FAR-DC-BRT — FillinRelate D→C, BRT: D→C BRT: CRITICAL; Bug #5
...
| **Scenario**            | Source SFV(`2026-03-15T00:00:00`) → GFV → URL param → Target C, BRT                               |
...
| 6   | Capture target raw value                                     | `VV.Form.VV.FormPartition.getValueObjectValue('Field6')`                                                                                                                                                                                       | `"2026-03-14T21:00:00"`      | ☐   |
...
- Interpretation: D→C BRT: CRITICAL. Source fake Z (BRT midnight labeled as UTC) → target C treats as real UTC midnight → stores BRT 21:00 Mar 14. API shows "correct" UTC but represents the wrong moment (-3h shift).
...
| Reference               | Location                                                            |
| ----------------------- | ------------------------------------------------------------------- |
| Matrix row              | `matrix.md` — row `4-FAR-DC-BRT`                                    |
| Run history             | [`summaries/tc-4-FAR-DC-BRT.md`](../summaries/tc-4-FAR-DC-BRT.md)   |
| Latest run              | [`runs/tc-4-FAR-DC-BRT-run-1.md`](../runs/tc-4-FAR-DC-BRT-run-1.md) |
