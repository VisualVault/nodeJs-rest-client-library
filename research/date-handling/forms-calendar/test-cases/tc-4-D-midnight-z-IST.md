# TC-4-D-midnight-z-IST — Config D, URL Parameter, IST: FORM-BUG-1 midnight in IST: UTC midnight becomes 05:30 IST; Bug #1, Bug #5
...
| **Scenario**            | URL param `Field5=2026-03-15T00:00:00.000Z`, IST                                                                |
...
| 2   | Capture raw stored value (DevTools console)     | `VV.Form.VV.FormPartition.getValueObjectValue('Field5')` | `"2026-03-15T05:30:00"`                          | ☐   |
| 3   | Capture GetFieldValue return (DevTools console) | `VV.Form.GetFieldValue('Field5')`                        | `"2026-03-15T05:30:00.000Z"`                     | ☐   |
...
**FAIL-1 (Wrong raw value):** Step 2 returns a value different from `"2026-03-15T05:30:00"`.

- Bugs exercised: Bug #1, Bug #5
- Interpretation: FORM-BUG-1 midnight in IST: UTC midnight becomes 05:30 IST. Date stays Mar 15 (no day shift), but time is wrong.

**FAIL-2 (Wrong API value):** Step 3 returns a value different from `"2026-03-15T05:30:00.000Z"`.
...
| Reference              | Location                                                                        |
| ---------------------- | ------------------------------------------------------------------------------- |
| Matrix row             | `matrix.md` — row `4-D-midnight-z-IST`                                          |
| Run history            | [`summaries/tc-4-D-midnight-z-IST.md`](../summaries/tc-4-D-midnight-z-IST.md)   |
| Latest run             | [`runs/tc-4-D-midnight-z-IST-run-1.md`](../runs/tc-4-D-midnight-z-IST-run-1.md) |
