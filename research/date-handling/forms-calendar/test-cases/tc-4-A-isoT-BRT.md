# TC-4-A-isoT-BRT — Config A, URL Parameter, BRT: Date-only with ISO+T in URL
...
| **Scenario**            | URL param `Field7=2026-03-15T00:00:00`, BRT                                                                       |
...
- Bugs exercised: none
- Interpretation: Date-only with ISO+T in URL. BRT baseline — correct storage, T stripped by V1 substring logic.
...
| Reference              | Location                                                            |
| ---------------------- | ------------------------------------------------------------------- |
| Matrix row             | `matrix.md` — row `4-A-isoT-BRT`                                    |
| Run history            | [`summaries/tc-4-A-isoT-BRT.md`](../summaries/tc-4-A-isoT-BRT.md)   |
| Latest run             | [`runs/tc-4-A-isoT-BRT-run-1.md`](../runs/tc-4-A-isoT-BRT-run-1.md) |
