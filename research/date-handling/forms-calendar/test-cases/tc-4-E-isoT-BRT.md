# TC-4-E-isoT-BRT — Config E, URL Parameter, BRT: Legacy date-only via URL
...
| **Target Field Config** | `enableTime=false`, `ignoreTimezone=false`, `useLegacy=true`, `enableInitialValue=false`, `enableQListener=true` |
| **Scenario**            | URL param `Field12=2026-03-15T00:00:00`, BRT                                                                     |
...
```text
https://vvdemo.visualvault.com/FormViewer/app?hidemenu=true&formid=203734a0-5433-f111-ba23-0afff212cc87&xcid=815eb44d-5ec8-eb11-8200-a8333ebd7939&xcdid=845eb44d-5ec8-eb11-8200-a8333ebd7939&Field12=2026-03-15T00%3A00%3A00
```
...
Object.values(VV.Form.VV.FormPartition.fieldMaster)
    .filter((f) => f.fieldType === 13 && f.name === 'Field12')
    .map((f) => ({ name: f.name, enableQListener: f.enableQListener }));
// Expected: [{ name: "Field12", enableQListener: true }]
```
...
| 2   | Capture raw stored value (DevTools console)     | `VV.Form.VV.FormPartition.getValueObjectValue('Field12')` | `"2026-03-15"`                                   | ☐   |
| 3   | Capture GetFieldValue return (DevTools console) | `VV.Form.GetFieldValue('Field12')`                        | `"2026-03-15"`                                   | ☐   |
...
- Bugs exercised: none
- Interpretation: Legacy date-only via URL. enableQListener works with useLegacy. Display shows (no input) — legacy widget does not render URL value visually.
...
| Reference              | Location                                                            |
| ---------------------- | ------------------------------------------------------------------- |
| Matrix row             | `matrix.md` — row `4-E-isoT-BRT`                                    |
| Run history            | [`summaries/tc-4-E-isoT-BRT.md`](../summaries/tc-4-E-isoT-BRT.md)   |
| Latest run             | [`runs/tc-4-E-isoT-BRT-run-1.md`](../runs/tc-4-E-isoT-BRT-run-1.md) |
