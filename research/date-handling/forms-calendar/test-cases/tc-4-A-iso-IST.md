# TC-4-A-iso-IST — Config A, URL Parameter, IST: Date-only without T in IST
...
| **Scenario**            | URL param `Field7=2026-03-15`, IST                                                                                |
...
- Bugs exercised: none
- Interpretation: Date-only without T in IST. No FORM-BUG-7 — URL path handles this correctly.
...
| Reference              | Location                                                          |
| ---------------------- | ----------------------------------------------------------------- |
| Matrix row             | `matrix.md` — row `4-A-iso-IST`                                   |
| Run history            | [`summaries/tc-4-A-iso-IST.md`](../summaries/tc-4-A-iso-IST.md)   |
| Latest run             | [`runs/tc-4-A-iso-IST-run-1.md`](../runs/tc-4-A-iso-IST-run-1.md) |
