# TC-4-G-z-BRT — Config G, URL Parameter, BRT: Legacy DateTime with Z; Bug #1
...
| **Scenario**            | URL param `Field14=2026-03-15T14:30:00.000Z`, BRT                                                               |
...
| 2   | Capture raw stored value (DevTools console)     | `VV.Form.VV.FormPartition.getValueObjectValue('Field14')` | `"2026-03-15T11:30:00"`                          | ☐   |
| 3   | Capture GetFieldValue return (DevTools console) | `VV.Form.GetFieldValue('Field14')`                        | `"2026-03-15T11:30:00"`                          | ☐   |
...
- Interpretation: Legacy DateTime with Z. FORM-BUG-1: Z stripped, -3h shift. No fake Z on API (useLegacy=true bypasses Bug #5).

**FAIL-2 (Wrong API value):** Step 3 returns a value different from `"2026-03-15T11:30:00"`.
...
| Reference              | Location                                                      |
| ---------------------- | ------------------------------------------------------------- |
| Matrix row             | `matrix.md` — row `4-G-z-BRT`                                 |
| Run history            | [`summaries/tc-4-G-z-BRT.md`](../summaries/tc-4-G-z-BRT.md)   |
| Latest run             | [`runs/tc-4-G-z-BRT-run-1.md`](../runs/tc-4-G-z-BRT-run-1.md) |
