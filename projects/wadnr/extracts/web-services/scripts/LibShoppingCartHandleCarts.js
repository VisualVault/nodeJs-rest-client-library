/**
 * LibShoppingCartHandleCarts
 * Category: Workflow
 * Modified: 2025-12-22T19:15:52.613Z by mauro.rapuano@visualvault.com
 * Script ID: Script Id: cd44646d-83d2-ef11-82c1-f717fbb433ff
    ...
    */
    ...
    try {
        ...
        if (shoppingCartID) {
            ...
            queryParams.push({
                parameterName: 'isPaidByCheck',
                value: Number(isPaidByCheck),
            });

            queryParams.push({
                parameterName: 'customerPaysCCTP',
                value: Number(customerPaysCCTP),
            });
        }
