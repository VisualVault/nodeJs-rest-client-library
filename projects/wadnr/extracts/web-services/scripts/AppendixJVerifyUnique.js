/**
 * AppendixJVerifyUnique
 * Category: Form
 * Modified: 2025-05-29T19:57:05.997Z by mauro.rapuano@visualvault.com
 * Script ID: Script Id: 363c888a-7cdd-ef11-82c3-a94025797804
...
module.exports.main = async function (ffCollection, vvClient, response) {
    /*
    Script Name:    AppendixJVerifyUnique
    Customer:       WADNR
    Purpose:        Check if an Appendix J Forest Practices Marbled Murrelet is duplicated by Related Record ID
    Preconditions:
    ...
    Date of Dev:    01/27/2025
    Last Rev Date:  01/27/2025
 
    Revision Notes:
                    01/27/2025 - Mauro Rapuano:  First Setup of the script
    */

    logger.info(`Start of the process AppendixJVerifyUnique at ${Date()}`);
    ...
    function verifyUniqueRecord(relatedRecordID, formId) {
        const uniqueRecordArr = [
            {
                name: 'templateId',
                value: 'Appendix J Forest Practices Marbled Murrelet',
            },
            {
                name: 'query',
    ...
    try {
        ...
        if (!unique || unique.toLowerCase() === 'error') {
            ...
            errorLog.push(
                'Not Unique - A duplicate Appendix J Forest Practices Marbled Murrelet was found. Please review the form information and make any necessary changes.'
            );
            throw new Error();
        }
        ...
        outputCollection[1] = `Appendix J Forest Practices Marbled Murrelet is ${unique}`;
