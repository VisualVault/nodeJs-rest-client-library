 ...
 * WTMFRelateToWTMRP
 * Category: Workflow
 * Modified: 2025-10-06T13:07:27.653Z by lucas.herrera@visualvault.com
 * Script ID: Script Id: bb414247-b5a2-f011-82f9-cf43b5202663
...
module.exports.main = async function (ffCollection, vvClient, response) {
    /*
    Script Name:    WTMFRelateToWTMRP
    Customer:       WADNR
    Purpose:        The purpose of this script is to update or create Associated Document Relations between WTMF and WTMF records based on the IDs provided. Forms will be related each other.
    ...
    Parameters:     The following represent variables passed into the function:
                    ...
                    - WTMF Number:           This is the WTMF Number so we can find the records
                                             to associate.
    Return Object:
    ...
    Pseudo code: 
                    1° Get, if exist, the related WTMF records for current WTMF Record.
                    2° Call the library LibApplicationReviewCollectRelatedDocs that update or create Document Associated Relation
                    3° Related the current record with the related WTMF records
                    4° Relate the current form with WTMF records
    ...
    Revision Notes:
                    10/06/2025 - Lucas Herrera: First Setup of the script.
    */

    logger.info(`Start of the process WTMFRelateToWTMRP at ${Date()}`);
    ...
    try {
        ...
        const WTMFNumberString = getFieldValueByName('WTMF Number');

        // 2° Check is the required parameters are present
        if (!wtmfFormId || !WTMFNumberString) {
        ...
        await relateForms(WTMFNumberString, wtmfFormId);
