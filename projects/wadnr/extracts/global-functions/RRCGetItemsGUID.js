/**
 * VV.Form.Global.RRCGetItemsGUID
 * Parameters: 1
 * Extracted: 2026-04-10
 */
function (rrcConfig) {
/*
       Script Name:   RRCGetItemGuids
       Customer:      VisualVault
       Purpose:       Get list of records from an RRC to validate existence. Return an array of dataIds.            
       Parameters:    
       ...
       Date of Dev:   
       Last Rev Date:  19/03/2024
       Revision Notes:
       19/03/2024 - Lucas Herrera - Initial Creation of Global Script 
   */
       var rrcConfig;
       var maxRows = 20;
       var titleText = "RRCGetItemGuids has returned an unexpected error";
       var messageText = "";
       var rrcControl = {};
       var rrcRows = [];
       var selectedRows = [];
       ...
       try {
         ...
         if (isNullOrUndefined(rrcConfig.RRCName)) {
           ...
           rrcRows =
             rrcControl.childNodes[0].childNodes[4].childNodes[2].childNodes[1]
               .childNodes[0].childNodes[0].childNodes[1].childNodes;
         }
         ...
         if (selectedRows.length == 0) {
           messageText =
             "No records have been selected. Please select at least 1 record to perform this task.";
         ...
         VV.Form.Global.DisplayModal({
           Icon: "error",
           Title: titleText,
           HtmlContent: messageText || error.message,
         });
       }
