# Standards Review: FPNP-County

Generated: 2026-04-15 | Rules: 40 | Findings: 18 (0 errors, 11 warnings, 7 info)
...
| accessibility-label-match | Email | Page 1 | AccessibilityLabel "Related Record ID" does not match expected "Email" |
| accessibility-label-match | SAW User ID | Page 1 | AccessibilityLabel "Related Record ID" does not match expected "SAW User ID" |
