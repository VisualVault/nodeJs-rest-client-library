...
|---|---|---|---|---|
| 1 | 2026-04-13 | BRT | PARTIAL (vv5dev) | [run-1](../runs/tc-16-A-controls-run-1.md) |
| 2 | 2026-04-13 | BRT | PASS (vvdemo) | [emanueljofre run-1](../../../../projects/emanueljofre/testing/date-handling/forms-calendar/runs/tc-16-A-controls-run-1.md) |
