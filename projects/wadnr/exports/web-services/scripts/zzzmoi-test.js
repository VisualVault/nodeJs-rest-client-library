 ...
 * zzzmoi-test
 * Category: Workflow
 * Modified: 2025-06-03T20:37:58.803Z by moises.savelli@visualvault.com
 * Script ID: Script Id: 5f009543-3e2b-f011-82d8-c702f4413de2
 * Extracted from WADNR (vv5dev/fpOnline) on 2026-04-08
 */
// just for testing and debugging ws
...
module.exports.main = async function (ffCollection, vvClient, response) {
    ...
    */
    ...
    logger.info(`Start of the process moi test at ${Date()}`);
    ...
    try {
        ...
        const timenow = `${hours}:${minutes}:${seconds} ${ampm}`;

        console.log(timenow);

        outputCollection[0] = 'Success'; // Don´t change this
        outputCollection[1] = 'Sucess';
        outputCollection[2] = timenow;
    } catch (error) {
