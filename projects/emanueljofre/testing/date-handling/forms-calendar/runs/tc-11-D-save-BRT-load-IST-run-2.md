...
**Spec**: [tc-11-D-save-BRT-load-IST.md](tasks/date-handling/forms-calendar/test-cases/tc-11-D-save-BRT-load-IST.md) | **Summary**: [summary](../summaries/tc-11-D-save-BRT-load-IST.md)
