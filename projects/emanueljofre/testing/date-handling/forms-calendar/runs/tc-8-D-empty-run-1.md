# TC-8-D-empty — Run 1 | 2026-04-03 | BRT | FAIL

**Spec**: [tc-8-D-empty.md](tasks/date-handling/forms-calendar/test-cases/tc-8-D-empty.md) | **Summary**: [summary](../summaries/tc-8-D-empty.md)
...
- Firefox verification for TC-8-D-empty
