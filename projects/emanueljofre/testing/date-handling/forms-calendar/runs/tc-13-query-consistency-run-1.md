...
**Spec**: [tc-13-query-consistency.md](tasks/date-handling/forms-calendar/test-cases/tc-13-query-consistency.md) | **Summary**: [summary](../summaries/tc-13-query-consistency.md)
