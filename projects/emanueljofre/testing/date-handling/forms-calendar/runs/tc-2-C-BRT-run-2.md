# TC-2-C-BRT — Run 2 | 2026-04-03 | BRT | FAIL

**Spec**: [tc-2-C-BRT.md](tasks/date-handling/forms-calendar/test-cases/tc-2-C-BRT.md) | **Summary**: [summary](../summaries/tc-2-C-BRT.md)
...
- Firefox verification for TC-2-C-BRT
