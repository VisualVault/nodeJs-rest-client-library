...
**Spec**: [tc-2-10-db-storage-mixed-tz-brt.md](tasks/date-handling/forms-calendar/test-cases/tc-2-10-db-storage-mixed-tz-brt.md) | **Summary**: [summary](../summaries/tc-13-user-input.md)
