...
**Spec**: [tc-13-preset-vs-user-input.md](tasks/date-handling/forms-calendar/test-cases/tc-13-preset-vs-user-input.md) | **Summary**: [summary](../summaries/tc-13-preset-vs-user-input.md)
