# TC-7-C-dateOnly — Run 2 | 2026-04-09 | BRT | PASS
...
- Chromium verification for TC-7-C-dateOnly
- Cross-browser consistency confirmed — chromium matches prior engine results
- Test context: Config C control. Date-only string parsed as local BRT midnight → stored as-is. GFV returns real UTC (+3h).
