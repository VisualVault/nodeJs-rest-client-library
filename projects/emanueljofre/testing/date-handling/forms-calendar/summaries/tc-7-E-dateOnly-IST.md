...
**Spec**: [tc-7-E-dateOnly-IST.md](tasks/date-handling/forms-calendar/test-cases/tc-7-E-dateOnly-IST.md)
...
| 2   | 2026-04-09 | IST | FAIL    | [run-2](../runs/tc-7-E-dateOnly-IST-run-2.md) |
