...
**Spec**: [tc-7-B-dateOnly-BRT.md](tasks/date-handling/forms-calendar/test-cases/tc-7-B-dateOnly-BRT.md)
...
| 2   | 2026-04-09 | BRT | PASS    | [run-2](../runs/tc-7-B-dateOnly-BRT-run-2.md) |
