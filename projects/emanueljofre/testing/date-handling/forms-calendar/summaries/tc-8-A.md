...
**Spec**: [tc-8-A.md](tasks/date-handling/forms-calendar/test-cases/tc-8-A.md)
**Current status**: PASS — last run 2026-04-09 (BRT, Chromium)
**Bug surface**: none — date-only GFV returns raw unchanged
...
| 1   | 2026-04-03 | BRT | PASS    | [run-1](../runs/tc-8-A-run-1.md)           |
| 2   | 2026-04-09 | BRT | PASS    | [run-2](../runs/tc-8-A-run-2.md)           |
