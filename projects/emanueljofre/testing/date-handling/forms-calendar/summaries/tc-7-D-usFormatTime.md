# TC-7-D-usFormatTime — Summary

**Spec**: [tc-7-D-usFormatTime.md](tasks/date-handling/forms-calendar/test-cases/tc-7-D-usFormatTime.md)
...
| 1   | 2026-04-03 | BRT | FAIL    | [run-1](../runs/tc-7-D-usFormatTime-run-1.md) |
| 2   | 2026-04-09 | BRT | FAIL    | [run-2](../runs/tc-7-D-usFormatTime-run-2.md) |
