...
**Spec**: [tc-7-A-isoZ.md](tasks/date-handling/forms-calendar/test-cases/tc-7-A-isoZ.md)
...
| 1   | 2026-04-03 | BRT | PASS    | [run-1](../runs/tc-7-A-isoZ-run-1.md)      |
| 2   | 2026-04-09 | BRT | PASS    | [run-2](../runs/tc-7-A-isoZ-run-2.md)      |
