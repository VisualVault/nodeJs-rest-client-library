...
**Spec**: [tc-12-invalid-string.md](tasks/date-handling/forms-calendar/test-cases/tc-12-invalid-string.md)
...
| 1   | 2026-04-03 | BRT | FAIL    | [run-1](../runs/tc-12-invalid-string-run-1.md) |
| 2   | 2026-04-09 | BRT | FAIL    | [run-2](../runs/tc-12-invalid-string-run-2.md) |
