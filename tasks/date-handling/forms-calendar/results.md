...
2. **HIGH — Category 1/2 IST (popup vs typed for Config A)**: Open form in IST, pick March 15 from popup on Field7, then type 03/15/2026 — compare stored values. Expected: popup → `"2026-03-13"`, typed → `"2026-03-14"` (different due to Bug #7 Date object vs string asymmetry).
