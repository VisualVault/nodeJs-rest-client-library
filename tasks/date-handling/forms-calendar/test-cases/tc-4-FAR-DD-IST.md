# TC-4-FAR-DD-IST — FillinRelate D→D, IST: D→D IST: Bugs compound same as BRT; Bug #5, Bug #1
...
| **Scenario**            | Source SFV(`2026-03-15T00:00:00`) → GFV → URL param → Target D, IST                               |
...
| 6   | Capture target raw value                                     | `VV.Form.VV.FormPartition.getValueObjectValue('Field5')`                                                                                                                                                                                       | `"2026-03-15T05:30:00"`      | ☐   |
| 7   | Capture target API value                                     | `VV.Form.GetFieldValue('Field5')`                                                                                                                                                                                                              | `"2026-03-15T05:30:00.000Z"` | ☐   |
...
- Interpretation: D→D IST: Bugs compound same as BRT. Source fake Z ".000Z" → strip Z → ".000" → UTC parse → UTC midnight in IST = 05:30 Mar 15. The .000 residue causes UTC interpretation.

**FAIL-3 (Target API mismatch):** Step 7 returns a value different from `"2026-03-15T05:30:00.000Z"`.
...
| Reference               | Location                                                            |
| ----------------------- | ------------------------------------------------------------------- |
| Matrix row              | `matrix.md` — row `4-FAR-DD-IST`                                    |
| Run history             | [`summaries/tc-4-FAR-DD-IST.md`](../summaries/tc-4-FAR-DD-IST.md)   |
| Latest run              | [`runs/tc-4-FAR-DD-IST-run-1.md`](../runs/tc-4-FAR-DD-IST-run-1.md) |
