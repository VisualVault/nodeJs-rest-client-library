# TC-4-A-isoT-IST — Config A, URL Parameter, IST: Date-only + IST via URL param
...
| **Scenario**            | URL param `Field7=2026-03-15T00:00:00`, IST                                                                       |
...
- Bugs exercised: none
- Interpretation: Date-only + IST via URL param. Key finding: FORM-BUG-7 does NOT affect URL parameter path. Correct date stored even in UTC+.
...
| Reference              | Location                                                            |
| ---------------------- | ------------------------------------------------------------------- |
| Matrix row             | `matrix.md` — row `4-A-isoT-IST`                                    |
| Run history            | [`summaries/tc-4-A-isoT-IST.md`](../summaries/tc-4-A-isoT-IST.md)   |
| Latest run             | [`runs/tc-4-A-isoT-IST-run-1.md`](../runs/tc-4-A-isoT-IST-run-1.md) |
