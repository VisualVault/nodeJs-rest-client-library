# TC-4-D-midnight-z-BRT — Config D, URL Parameter, BRT: FORM-BUG-1 midnight edge: UTC midnight becomes Mar 14 21:00 BRT; Bug #1, Bug #5
...
| **Scenario**            | URL param `Field5=2026-03-15T00:00:00.000Z`, BRT                                                                |
...
| 2   | Capture raw stored value (DevTools console)     | `VV.Form.VV.FormPartition.getValueObjectValue('Field5')` | `"2026-03-14T21:00:00"`                          | ☐   |
| 3   | Capture GetFieldValue return (DevTools console) | `VV.Form.GetFieldValue('Field5')`                        | `"2026-03-14T21:00:00.000Z"`                     | ☐   |
...
**FAIL-1 (Wrong raw value):** Step 2 returns a value different from `"2026-03-14T21:00:00"`.

- Bugs exercised: Bug #1, Bug #5
- Interpretation: FORM-BUG-1 midnight edge: UTC midnight becomes Mar 14 21:00 BRT. Date shifts back one day. Critical for FillinAndRelate chains.

**FAIL-2 (Wrong API value):** Step 3 returns a value different from `"2026-03-14T21:00:00.000Z"`.
...
| Reference              | Location                                                                        |
| ---------------------- | ------------------------------------------------------------------------------- |
| Matrix row             | `matrix.md` — row `4-D-midnight-z-BRT`                                          |
| Run history            | [`summaries/tc-4-D-midnight-z-BRT.md`](../summaries/tc-4-D-midnight-z-BRT.md)   |
| Latest run             | [`runs/tc-4-D-midnight-z-BRT-run-1.md`](../runs/tc-4-D-midnight-z-BRT-run-1.md) |
