# TC-4-C-noz-BRT — Config C, URL Parameter, BRT: Config C without Z
...
| **Scenario**            | URL param `Field6=2026-03-15T14:30:00`, BRT                                                                      |
...
```text
https://vvdemo.visualvault.com/FormViewer/app?hidemenu=true&formid=203734a0-5433-f111-ba23-0afff212cc87&xcid=815eb44d-5ec8-eb11-8200-a8333ebd7939&xcdid=845eb44d-5ec8-eb11-8200-a8333ebd7939&Field6=2026-03-15T14%3A30%3A00
```
...
| 2   | Capture raw stored value (DevTools console)     | `VV.Form.VV.FormPartition.getValueObjectValue('Field6')` | `"2026-03-15T14:30:00"`                          | ☐   |
| 3   | Capture GetFieldValue return (DevTools console) | `VV.Form.GetFieldValue('Field6')`                        | `"2026-03-15T17:30:00.000Z"`                     | ☐   |
...
- Bugs exercised: none
- Interpretation: Config C without Z. Treated as local 14:30 BRT. Raw preserves local time. API returns UTC equivalent (+3h).

**FAIL-2 (Wrong API value):** Step 3 returns a value different from `"2026-03-15T17:30:00.000Z"`.
...
| Reference              | Location                                                          |
| ---------------------- | ----------------------------------------------------------------- |
| Matrix row             | `matrix.md` — row `4-C-noz-BRT`                                   |
| Run history            | [`summaries/tc-4-C-noz-BRT.md`](../summaries/tc-4-C-noz-BRT.md)   |
| Latest run             | [`runs/tc-4-C-noz-BRT-run-1.md`](../runs/tc-4-C-noz-BRT-run-1.md) |
