# TC-4-D-noz-BRT — Config D, URL Parameter, BRT: Config D without Z; Bug #5
...
| **Scenario**            | URL param `Field5=2026-03-15T14:30:00`, BRT                                                                     |
...
```text
https://vvdemo.visualvault.com/FormViewer/app?hidemenu=true&formid=203734a0-5433-f111-ba23-0afff212cc87&xcid=815eb44d-5ec8-eb11-8200-a8333ebd7939&xcdid=845eb44d-5ec8-eb11-8200-a8333ebd7939&Field5=2026-03-15T14%3A30%3A00
```
...
| 2   | Capture raw stored value (DevTools console)     | `VV.Form.VV.FormPartition.getValueObjectValue('Field5')` | `"2026-03-15T14:30:00"`                          | ☐   |
| 3   | Capture GetFieldValue return (DevTools console) | `VV.Form.GetFieldValue('Field5')`                        | `"2026-03-15T14:30:00.000Z"`                     | ☐   |
...
**FAIL-1 (Wrong raw value):** Step 2 returns a value different from `"2026-03-15T14:30:00"`.

- Bugs exercised: Bug #5
- Interpretation: Config D without Z. Correct local storage (no Z to strip). But API still adds fake Z (Bug #5).
...
| Reference              | Location                                                          |
| ---------------------- | ----------------------------------------------------------------- |
| Matrix row             | `matrix.md` — row `4-D-noz-BRT`                                   |
| Run history            | [`summaries/tc-4-D-noz-BRT.md`](../summaries/tc-4-D-noz-BRT.md)   |
| Latest run             | [`runs/tc-4-D-noz-BRT-run-1.md`](../runs/tc-4-D-noz-BRT-run-1.md) |
