# TC-4-A-us-BRT — Config A, URL Parameter, BRT: US date format in URL
...
| **Scenario**            | URL param `Field7=03/15/2026`, BRT                                                                                |
...
- Bugs exercised: none
- Interpretation: US date format in URL. Stored as-is without ISO normalization — raw preserves MM/DD/YYYY.
...
| Reference              | Location                                                        |
| ---------------------- | --------------------------------------------------------------- |
| Matrix row             | `matrix.md` — row `4-A-us-BRT`                                  |
| Run history            | [`summaries/tc-4-A-us-BRT.md`](../summaries/tc-4-A-us-BRT.md)   |
| Latest run             | [`runs/tc-4-A-us-BRT-run-1.md`](../runs/tc-4-A-us-BRT-run-1.md) |
