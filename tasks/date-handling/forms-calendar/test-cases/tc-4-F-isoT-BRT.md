# TC-4-F-isoT-BRT — Config F, URL Parameter, BRT: Legacy date-only+ignoreTZ
...
| **Target Field Config** | `enableTime=false`, `ignoreTimezone=true`, `useLegacy=true`, `enableInitialValue=false`, `enableQListener=true` |
| **Scenario**            | URL param `Field11=2026-03-15T00:00:00`, BRT                                                                    |
...
```text
https://vvdemo.visualvault.com/FormViewer/app?hidemenu=true&formid=203734a0-5433-f111-ba23-0afff212cc87&xcid=815eb44d-5ec8-eb11-8200-a8333ebd7939&xcdid=845eb44d-5ec8-eb11-8200-a8333ebd7939&Field11=2026-03-15T00%3A00%3A00
```
...
Object.values(VV.Form.VV.FormPartition.fieldMaster)
    .filter((f) => f.fieldType === 13 && f.name === 'Field11')
    .map((f) => ({ name: f.name, enableQListener: f.enableQListener }));
// Expected: [{ name: "Field11", enableQListener: true }]
```
...
| 2   | Capture raw stored value (DevTools console)     | `VV.Form.VV.FormPartition.getValueObjectValue('Field11')` | `"2026-03-15"`                                   | ☐   |
| 3   | Capture GetFieldValue return (DevTools console) | `VV.Form.GetFieldValue('Field11')`                        | `"2026-03-15"`                                   | ☐   |
...
- Bugs exercised: none
- Interpretation: Legacy date-only+ignoreTZ. Same as Config E — ignoreTZ inert for date-only.
...
| Reference              | Location                                                            |
| ---------------------- | ------------------------------------------------------------------- |
| Matrix row             | `matrix.md` — row `4-F-isoT-BRT`                                    |
| Run history            | [`summaries/tc-4-F-isoT-BRT.md`](../summaries/tc-4-F-isoT-BRT.md)   |
| Latest run             | [`runs/tc-4-F-isoT-BRT-run-1.md`](../runs/tc-4-F-isoT-BRT-run-1.md) |
