# TC-4-FAR-CA-IST — FillinRelate C→A, IST: C→A IST: Source C returns "2026-03-14T18:30:00
...
| **Scenario**            | Source SFV(`2026-03-15T00:00:00`) → GFV → URL param → Target A, IST                                |
...
| 4   | Capture source GFV (this is what FillinAndRelate passes)     | `VV.Form.GetFieldValue('Field6')`                                                                                                                                                                                                              | `"2026-03-14T18:30:00.000Z"` | ☐   |
...
**FAIL-1 (Source GFV mismatch):** Step 4 returns a value different from `"2026-03-14T18:30:00.000Z"`.
...
- Bugs exercised: none
- Interpretation: C→A IST: Source C returns "2026-03-14T18:30:00.000Z" (real UTC of IST midnight). Target A truncates at T → "2026-03-14". Wrong date — the UTC date portion is previous day. Not a URL bug — the UTC representation correctly has Mar 14.
...
| Reference               | Location                                                            |
| ----------------------- | ------------------------------------------------------------------- |
| Matrix row              | `matrix.md` — row `4-FAR-CA-IST`                                    |
| Run history             | [`summaries/tc-4-FAR-CA-IST.md`](../summaries/tc-4-FAR-CA-IST.md)   |
| Latest run              | [`runs/tc-4-FAR-CA-IST-run-1.md`](../runs/tc-4-FAR-CA-IST-run-1.md) |
