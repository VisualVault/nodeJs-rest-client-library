# TC-4-A-isoZ-BRT — Config A, URL Parameter, BRT: Date-only with full ISO+Z
...
| **Scenario**            | URL param `Field7=2026-03-15T00:00:00.000Z`, BRT                                                                  |
...
```text
https://vvdemo.visualvault.com/FormViewer/app?hidemenu=true&formid=203734a0-5433-f111-ba23-0afff212cc87&xcid=815eb44d-5ec8-eb11-8200-a8333ebd7939&xcdid=845eb44d-5ec8-eb11-8200-a8333ebd7939&Field7=2026-03-15T00%3A00%3A00.000Z
```
...
| 2   | Capture raw stored value (DevTools console)     | `VV.Form.VV.FormPartition.getValueObjectValue('Field7')` | `"2026-03-15"`                                   | ☐   |
| 3   | Capture GetFieldValue return (DevTools console) | `VV.Form.GetFieldValue('Field7')`                        | `"2026-03-15"`                                   | ☐   |
...
- Bugs exercised: none
- Interpretation: Date-only with full ISO+Z. Z stripped by T-truncation before moment parse. Correct in BRT.
...
| Reference              | Location                                                            |
| ---------------------- | ------------------------------------------------------------------- |
| Matrix row             | `matrix.md` — row `4-A-isoZ-BRT`                                    |
| Run history            | [`summaries/tc-4-A-isoZ-BRT.md`](../summaries/tc-4-A-isoZ-BRT.md)   |
| Latest run             | [`runs/tc-4-A-isoZ-BRT-run-1.md`](../runs/tc-4-A-isoZ-BRT-run-1.md) |
