# TC-4-A-iso-BRT — Config A, URL Parameter, BRT: Date-only without T
...
| **Scenario**            | URL param `Field7=2026-03-15`, BRT                                                                                |
...
```text
https://vvdemo.visualvault.com/FormViewer/app?hidemenu=true&formid=203734a0-5433-f111-ba23-0afff212cc87&xcid=815eb44d-5ec8-eb11-8200-a8333ebd7939&xcdid=845eb44d-5ec8-eb11-8200-a8333ebd7939&Field7=2026-03-15
```
...
- Bugs exercised: none
- Interpretation: Date-only without T. Disproved hypothesis: V1 substring(0,-1) does NOT cause Invalid Date. Value stored correctly.
...
| Reference              | Location                                                          |
| ---------------------- | ----------------------------------------------------------------- |
| Matrix row             | `matrix.md` — row `4-A-iso-BRT`                                   |
| Run history            | [`summaries/tc-4-A-iso-BRT.md`](../summaries/tc-4-A-iso-BRT.md)   |
| Latest run             | [`runs/tc-4-A-iso-BRT-run-1.md`](../runs/tc-4-A-iso-BRT-run-1.md) |
