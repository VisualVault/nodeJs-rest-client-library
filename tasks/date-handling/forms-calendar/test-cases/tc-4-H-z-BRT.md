# TC-4-H-z-BRT — Config H, URL Parameter, BRT: Legacy DateTime+ignoreTZ Z; Bug #1
...
| **Scenario**            | URL param `Field13=2026-03-15T14:30:00.000Z`, BRT                                                              |
...
| 2   | Capture raw stored value (DevTools console)     | `VV.Form.VV.FormPartition.getValueObjectValue('Field13')` | `"2026-03-15T11:30:00"`                          | ☐   |
| 3   | Capture GetFieldValue return (DevTools console) | `VV.Form.GetFieldValue('Field13')`                        | `"2026-03-15T11:30:00"`                          | ☐   |
...
- Interpretation: Legacy DateTime+ignoreTZ Z. Same FORM-BUG-1 shift as Config G. No fake Z on API.
...
| Reference              | Location                                                      |
| ---------------------- | ------------------------------------------------------------- |
| Matrix row             | `matrix.md` — row `4-H-z-BRT`                                 |
| Run history            | [`summaries/tc-4-H-z-BRT.md`](../summaries/tc-4-H-z-BRT.md)   |
| Latest run             | [`runs/tc-4-H-z-BRT-run-1.md`](../runs/tc-4-H-z-BRT-run-1.md) |
