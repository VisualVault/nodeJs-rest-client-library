...
Step 8 returns `"2026-03-14T21:00:00"` — stored value shifted -3h from original. Step 7 display reads `03/14/2026 09:00 PM`.

- Interpretation: `getCalendarFieldValue()` appended a fake `Z` to `"2026-03-15T00:00:00"`, producing `"2026-03-15T00:00:00.000Z"`. When passed to `SetFieldValue`, JavaScript parsed it as UTC midnight and converted to BRT local time: 2026-03-14 21:00 (UTC−3). This is Bug #5. Each additional round-trip shifts another −3h. Correct stored value after round-trip is `"2026-03-15T00:00:00"` (unchanged).
