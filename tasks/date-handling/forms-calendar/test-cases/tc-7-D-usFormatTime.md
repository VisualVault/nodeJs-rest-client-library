# TC-7-D-usFormatTime — Config D, SetFieldValue US format with time, BRT: parsed and normalized; GFV adds fake Z (Bug #5)
...
| 2   | Set value via US format+time string (DevTools console) | `VV.Form.SetFieldValue('<FIELD_NAME>', '03/15/2026 12:00:00 AM')` | Field displays `03/15/2026 12:00 AM`                   | ☐   |
...
| Reference              | Location                                                                              |
| ---------------------- | ------------------------------------------------------------------------------------- |
| Matrix row             | `../matrix.md` — row `7-D-usFormatTime`                                               |
