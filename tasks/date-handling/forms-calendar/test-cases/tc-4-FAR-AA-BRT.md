# TC-4-FAR-AA-BRT — FillinRelate A→A, BRT: A→A BRT: date-only clean chain
...
| **Scenario**            | Source SFV(`2026-03-15`) → GFV → URL param → Target A, BRT                                          |
...
| 3   | Capture source raw value                                     | `VV.Form.VV.FormPartition.getValueObjectValue('Field7')`                                                                                                                                                                                       | `"2026-03-15"`            | ☐   |
| 4   | Capture source GFV (this is what FillinAndRelate passes)     | `VV.Form.GetFieldValue('Field7')`                                                                                                                                                                                                              | `"2026-03-15"`            | ☐   |
...
**FAIL-1 (Source GFV mismatch):** Step 4 returns a value different from `"2026-03-15"`.
...
- Bugs exercised: none
- Interpretation: A→A BRT: date-only clean chain. No bugs on either side. Value preserved.
...
| Reference               | Location                                                            |
| ----------------------- | ------------------------------------------------------------------- |
| Matrix row              | `matrix.md` — row `4-FAR-AA-BRT`                                    |
| Run history             | [`summaries/tc-4-FAR-AA-BRT.md`](../summaries/tc-4-FAR-AA-BRT.md)   |
| Latest run              | [`runs/tc-4-FAR-AA-BRT-run-1.md`](../runs/tc-4-FAR-AA-BRT-run-1.md) |
