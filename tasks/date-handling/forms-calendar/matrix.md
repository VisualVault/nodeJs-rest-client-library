...
| 6-C-BRT  |   C    |  BRT  | TBD — DateTime current date load path; UTC-based storage expected (Field17)                         | —                                                                                                                                            | PENDING | —          | —                                  |
| 6-D-BRT  |   D    |  BRT  | TBD — DateTime + ignoreTZ current date; GFV adds fake Z immediately on first read (Field18)         | —                                                                                                                                            | PENDING | —          | —                                  |
