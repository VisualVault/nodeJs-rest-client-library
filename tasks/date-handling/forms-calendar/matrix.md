...
| ------------- | :----: | :---: | ----------------------- | --------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------- | ------- | ---------- | ---------------------------------------- |
| 8-A           |   A    |  any  | `"2026-03-15"`          | `"2026-03-15"`                                                                                      | `"2026-03-15"`                                                      | PASS    | —          | [spec](test-cases/tc-8-A.md)             |
...
| 8-C-BRT       |   C    |  BRT  | `"2026-03-15T00:00:00"` | `"2026-03-15T03:00:00.000Z"` (real UTC)                                                             | `"2026-03-15T03:00:00.000Z"` (real UTC confirmed)                   | PASS    | —          | [spec](test-cases/tc-8-C-BRT.md)         |
| 8-C-IST       |   C    |  IST  | `"2026-03-15T00:00:00"` | `"2026-03-14T18:30:00.000Z"` (real UTC from IST)                                                    | `"2026-03-14T18:30:00.000Z"` (real UTC confirmed)                   | PASS    | —          | [spec](test-cases/tc-8-C-IST.md)         |
| 8-C-UTC0      |   C    | UTC+0 | `"2026-03-15T00:00:00"` | `"2026-03-15T00:00:00.000Z"` (real UTC at UTC+0 = stored value)                                     | —                                                                   | PENDING | —          | —                                        |
| 8-D-BRT       |   D    |  BRT  | `"2026-03-15T00:00:00"` | `"2026-03-15T00:00:00.000Z"` (**FAKE Z**)                                                           | `"2026-03-15T00:00:00.000Z"` (fake Z — not real UTC, Bug #5)        | FAIL    | —          | [spec](test-cases/tc-8-D-BRT.md)         |
| 8-D-IST       |   D    |  IST  | `"2026-03-15T00:00:00"` | `"2026-03-15T00:00:00.000Z"` (**FAKE Z** — TZ-invariant)                                            | `"2026-03-15T00:00:00.000Z"` (same fake Z regardless of TZ, Bug #5) | FAIL    | —          | [spec](test-cases/tc-8-D-IST.md)         |
| 8-D-UTC0      |   D    | UTC+0 | `"2026-03-15T00:00:00"` | `"2026-03-15T00:00:00.000Z"` (fake Z, coincidentally correct at UTC+0)                              | —                                                                   | PENDING | —          | —                                        |
| 8-D-empty     |   D    |  any  | `""`                    | `""` (expected) / `"Invalid Date"` (**Bug #6**)                                                     | `"Invalid Date"` (truthy string — Bug #6 confirmed)                 | FAIL    | —          | [spec](test-cases/tc-8-D-empty.md)       |
...
| 9-C-IST-1  |   C    |  IST  |   1   | 0 (stable)                                                                          | 0 drift — stable (confirmed)                              | PASS    | —          | [spec](test-cases/tc-9-C-IST-1.md)    |
| 9-A-any    |   A    |  any  |   1   | 0 (stable)                                                                          | 0 drift — stable (confirmed)                              | PASS    | —          | [spec](test-cases/tc-9-A-any.md)      |
| 9-B-any    |   B    |  any  |   1   | 0 (stable)                                                                          | 0 drift — stable (confirmed)                              | PASS    | —          | [spec](test-cases/tc-9-B-any.md)      |
...
| ------------------------- | :----: | :---: | ----------------------------- | ---------------------------- | ------------------------------------------------------------------------------ | ------------------------------------------------------------------------- | ------- | ---------- | ------------------------------------------------- |
| 12-near-midnight-1        |   D    |  BRT  | UTC input near midnight       | `"2026-03-15T00:30:00.000Z"` | Day crosses on input (BRT = Mar 14 21:30) + fake Z double jeopardy             | Stored `"2026-03-14T21:30:00"` (day crossed); GFV adds fake Z (confirmed) | FAIL    | —          | [spec](test-cases/tc-12-near-midnight-1.md)       |
...
| 12-near-midnight-2        |   D    |  BRT  | Local time near midnight      | `"2026-03-15T23:00:00"`      | 23:00→20:00→17:00→... (-3h/trip)                                               | 1 trip: 23:00→20:00 (−3h confirmed)                                       | FAIL    | —          | [spec](test-cases/tc-12-near-midnight-2.md)       |
...
| 12-dst-transition         |   D    |  BRT  | US DST change day             | `"2026-03-08T02:00:00"`      | -3h drift from BRT — no DST anomaly (Brazil has no DST)                        | -3h BRT drift confirmed; no DST anomaly                                   | PASS    | —          | [spec](test-cases/tc-12-dst-transition.md)        |
...
| 12-year-boundary          |   D    |  BRT  | Jan 1 midnight                | `"2026-01-01T00:00:00"`      | 1 trip → `"2025-12-31T21:00:00"` — year boundary crossed                       | 1 trip → `"2025-12-31T21:00:00"` (year crossed confirmed)                 | FAIL    | —          | [spec](test-cases/tc-12-year-boundary.md)         |
...
| 12-leap-day               |   D    |  BRT  | Feb 29 on leap year           | `"2028-02-29T00:00:00"`      | 1 trip → `"2028-02-28T21:00:00"` — leap day lost                               | 1 trip → `"2028-02-28T21:00:00"` (leap day lost confirmed)                | FAIL    | —          | [spec](test-cases/tc-12-leap-day.md)              |
...
| 12-empty-value            |   D    |  any  | Empty / null date             | `""` or `null`               | GFV returns truthy `"Invalid Date"` (Bug #6)                                   | `"Invalid Date"` (truthy string — Bug #6 confirmed)                       | FAIL    | —          | [spec](test-cases/tc-12-empty-value.md)           |
...
| 12-invalid-string         |   D    |  BRT  | Invalid string                | `"not-a-date"`               | Silently ignored, field retains previous value                                 | Field unchanged; no error thrown (confirmed)                              | PASS    | —          | [spec](test-cases/tc-12-invalid-string.md)        |
| 12-far-future             |   D    |  BRT  | Year 2099                     | `"2099-12-31T00:00:00"`      | Standard -3h drift, no special issue                                           | -3h drift; no special issue (confirmed)                                   | PASS    | —          | [spec](test-cases/tc-12-far-future.md)            |
| 12-pre-epoch              |   D    |  BRT  | Year 1969                     | `"1969-12-31T00:00:00"`      | Standard -3h drift, handles negative epoch                                     | -3h drift; negative epoch handled correctly (confirmed)                   | PASS    | —          | [spec](test-cases/tc-12-pre-epoch.md)             |
