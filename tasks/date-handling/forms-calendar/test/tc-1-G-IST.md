# TC-1-G-IST — Config G, Calendar Popup, IST: legacy popup stores UTC datetime; IST midnight = prev-day UTC; GFV same
...
| Reference                                         | Location                                           |
| ------------------------------------------------- | -------------------------------------------------- |
| Matrix row                                        | `matrix.md` — row `1-G-IST`                        |
| Run 1 results                                     | `runs/tc-1-G-IST-run-1.md`                         |
| Summary                                           | `summaries/tc-1-G-IST.md`                          |
| Bug #2 (inconsistent popup vs typed handlers)     | `analysis.md` § Bug #2                             |
| Bug #4 (legacy save format strips Z)              | `analysis.md` § Bug #4                             |
| Sibling — Config G, BRT                           | `tc-1-G-BRT.md`                                    |
| Sibling — Config E, IST (same legacy IST pattern) | `tc-1-E-IST.md`                                    |
| Sibling — Config F, IST (ignoreTZ no-op)          | `tc-1-F-IST.md`                                    |
| Sibling — Config H, IST (pending)                 | `tc-1-H-IST.md` (pending)                          |
