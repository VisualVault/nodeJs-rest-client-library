...
| 7   | Capture GetFieldValue return                                        | `` `VV.Form.GetFieldValue('<FIELD_NAME>')` ``                        | `"2026-03-14"` — same as raw; no fake Z            | ☐   |
...
| Bug #2 analysis        | `tasks/date-handling/forms-calendar/analysis.md` — Bug #2 section                       |
