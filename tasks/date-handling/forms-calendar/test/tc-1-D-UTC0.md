...
| 7   | Capture GetFieldValue output                                        | `` `VV.Form.GetFieldValue('<FIELD_NAME>')` ``                        | `"2026-03-15T00:00:00.000Z"` — fake Z (Bug #5) — coincidentally correct at UTC+0           | ☐   |
...
**FAIL-1 (Bug #5 drift — non-UTC+0 timezone):**
...
**FAIL-2 (Bug #5 — wrong fake Z format):**
...
**FAIL-3 (Bug #6 — empty field returns "Invalid Date"):**
...
**FAIL-5 (isoRef shows non-UTC+0 offset):**
