 ...
 * NCNURelateToARP
 * Category: Form
 * Modified: 2025-11-28T19:56:02.287Z by zharich.barona@visualvault.com
 * Script ID: Script Id: 02f82540-348f-f011-82f5-e43f3109388f
...
module.exports.main = async function (ffCollection, vvClient, response) {
    /*
    Script Name:    NCNURelateToARP
    Customer:       WADNR
    Purpose:        The purpose of this script is to update or create Associated Document Relations between NCNU and ARP forms. Also the forms will be related each other.
    Preconditions:  -
    Parameters:     The following represent variables passed into the function:
                    ...
                    - Status: The updated status of the current record to associate the documents and forms.
    Return Object:
    ...
    Last Rev Date:  09/17/2025
 
    Revision Notes:
                    09/11/2025 - SEBASTIAN ROLANDO:  First Setup of the script
                    09/11/2025 - SEBASTIAN ROLANDO:  Remove the -Relate Forms' action for this microservice, since that process already happen inside the library LibApplicationReviewCollectRelatedDocs
                    10/29/2025 - Sebastian Rolando: Update to only create relation for the NCNU form without calling library LibApplicationReviewCollectRelatedDocs
    */

    logger.info(`Start of the process NCNURelateToARP at ${Date()}`);
    ...
    async function getRecordGUID(formTemplateName, number) {
        /*
      Get the GUID of a record based on its FPAN number and form template name
      Parameters:
          formTemplateName: The name of the form template where the record is stored (ARP)
          number: The FPAN number
      Returns:
