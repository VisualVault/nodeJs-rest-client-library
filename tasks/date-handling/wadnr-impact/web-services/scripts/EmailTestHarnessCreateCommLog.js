/**
 * EmailTestHarnessCreateCommLog
 * Category: Form
 * Modified: 2024-10-24T19:45:58.58Z by brian.davis@visualvault.com
 * Script ID: Script Id: 4fe1a762-c290-ef11-82ae-862bfd7a22f1
...
module.exports.main = async function (ffCollection, vvClient, response) {
    /*Script Name:  EmailTestHarnessCreateCommLog
 Customer:      WADNR
 Purpose:       Test LibEmailGenerateAndCreateCommunicationLog
 Parameters:
    'Email Template Name'
    'Sent To'
    'Send CC'
 ...
 Psuedo code: 
            1. Call LibEmailGenerateAndCreateCommunicationLog
 ...
 */
    ...
    logger.info('Start of the EmailTestHarnessCreateCommLog at ' + Date());
    ...
    try {
        ...
        *********************/
        ...
        /*********************
         BEGIN ASYNC CODE
        *********************/
        //Step 1 - call LibEmailGenerateAndCreateCommunicationLog
