/**
 * AppendixHVerifyUnique
 * Category: Form
 * Modified: 2025-05-29T19:56:18.4Z by mauro.rapuano@visualvault.com
 * Script ID: Script Id: da35932e-61d7-ef11-82bf-f990b504e413
...
module.exports.main = async function (ffCollection, vvClient, response) {
    /*
    Script Name:    AppendixHVerifyUnique
    Customer:       WADNR
    Purpose:        Check if an Appendix H Eastern Washington Natural Regeneration Plan is duplicated by Related Record ID
    Preconditions:
    ...
    Last Rev Date:  05/29/2025
 
    Revision Notes:
                    01/20/2025 - Pablo Lopez:  First Setup of the script
                    05/29/2025 - Mauro Rapuano:  Query fix to check only for not Disabled records
    */

    logger.info(`Start of the process AppendixHVerifyUnique at ${Date()}`);
    ...
    function verifyUniqueRecord(relatedRecordID, formId) {
        const uniqueRecordArr = [
            {
                name: 'templateId',
                value: 'Appendix H Eastern Washington Natural Regeneration Plan',
            },
            {
                name: 'query',
    ...
    try {
        ...
        if (!unique || unique.toLowerCase() === 'error') {
            ...
            errorLog.push(
                'Not Unique - A duplicate Appendix H Eastern Washington Natural Regeneration Plan was found. Please review the form information and make any necessary changes.'
            );
            throw new Error();
        }
        ...
        outputCollection[1] = `Appendix H Eastern Washington Natural Regeneration Plan is ${unique}`;
