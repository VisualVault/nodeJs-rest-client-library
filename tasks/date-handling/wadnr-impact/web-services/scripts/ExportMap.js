 ...
 * ExportMap
 * Category: Workflow
 * Modified: 2025-01-09T17:11:48.777Z by ross.rhone@visualvault.com
 * Script ID: Script Id: 3f081aa5-acce-ef11-82bf-a0dcc70b93c8
...
module.exports.main = async function (Web_map_as_JSON, format, layout_Tmplate, f) {
    /*Script Name:   PostPDFMapToDocLib
     ...
     */
    logger.info(`Start of the process Export Map at ${Date()}`);
    ...
    function postDoc(docName, folderId) {
    ...
    try {
        console.log('web_map_as_json :  ' + Web_map_as_JSON);
        console.log('format :  ' + format);
        console.log('layout_template :  ' + layout_Tmplate);
        console.log('f :  ' + f);
