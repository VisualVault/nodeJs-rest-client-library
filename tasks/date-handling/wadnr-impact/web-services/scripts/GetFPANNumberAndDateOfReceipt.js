 ...
 * Category: Form
 * Modified: 2025-06-23T16:55:56.693Z by mauro.rapuano@visualvault.com
 * Script ID: Script Id: bd48c152-2ebe-ef11-82bb-89f96960e674
...
module.exports.main = async function (ffCollection, vvClient, response) {
    /*
    Script Name:    GetFPANNumberAndDateOfReceipt
    Customer:       WADNR
    Purpose:        Gets a unique FPAN reference ID (RE-FPA-YY-NNNN) for a specified Region, and corresponding Date Of Receipt.
                    Being:  RE - Region code (2 letters)
                            FPA - Form name (3 letters)
    ...
    Revision Notes:
                    12/19/2024 - Mauro Rapuano:  First Setup of the script
                    04/09/2025 - Nicolas Culini: Added parameteres and changed the way unique number is obtained
                    06/23/2025 - Alfredo Scilabra: Add HH:mm:ss to date output
    */

    logger.info(`Start of the process GetFPANNumberAndDateOfReceipt at ${Date()}`);
    ...
    const formTemplateName = 'Forest Practices Application Notification';
    ...
    try {
        ...
        const regionCode = getFieldValueByName('Region');
        const formType = getFieldValueByName('Form Type');
        const applicationReviewId = getFieldValueByName('Application Review Page ID');

        // 2° Check if the required parameters are present and complete list of holidays
        if (!formId || !regionCode || !formType || !applicationReviewId) {
        ...
        const uniqueNumber = applicationReviewId.substring(23);
        ...
        const returnObj = {
            FPAN_Number: uniqueReferenceID,
            DateOfReceipt: dateOfReceipt,
        };

        outputCollection[0] = 'Success'; // Don´t change this
        outputCollection[1] = 'FPAN Number and Date generated succesfully';
