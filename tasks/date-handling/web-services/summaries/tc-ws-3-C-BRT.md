...
Config C API round-trip (write → read → write-back → read, 2 cycles) produces zero drift. Sent "2026-03-15T14:30:00", all reads return the Z-normalized form. H-8 confirmed.
