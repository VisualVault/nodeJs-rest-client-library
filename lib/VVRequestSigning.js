 ...
 */
 	sign: function (headers, targetUrl, method, data, developerId, developerSecret) {
		...
		console.log("HexEncode 'abc': " + this.hexEncodedHash('abc'));
		
		console.log("----------Start String To Sign----------");
		console.log(stringToSign);
		console.log("----------End String To Sign----------\n\n\n");
		
		console.log("kSecret: " + developerSecret);
		
		console.log("kNonce: " + authNonce);
		
		console.log("x-vv-requestdate: " + xRequestDate);	
		...
		//        VVRequestSigning.urlsafeB64Encode(JSON.stringify(header)),
        //return crypto.createHmac(algorithms[algorithm], key).update(msg).digest('binary');
