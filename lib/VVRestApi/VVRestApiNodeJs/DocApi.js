...
module.exports = class DocApi {
    ...
    async getDocumentWebDavUrl(documentId) {
        let resourceUri = this._httpHelper._config.ResourceUri.DocApi.WebDavUrl;
    ...
    async getDocumentWopiUrl(documentId) {
        let resourceUri = this._httpHelper._config.ResourceUri.DocApi.WopiUrl;
        resourceUri = resourceUri.replace('{id}', documentId);
        const url = this._httpHelper.getUrl(resourceUri);
