...
var ServiceCoreUtilBase64Helper = (function () {
    function ServiceCoreUtilBase64Helper(serviceCoreUtil) {
        this._serviceCoreUtil = serviceCoreUtil;
    }
    ServiceCoreUtilBase64Helper.prototype.encode = function (string) {
        return new Buffer(string).toString('base64', null, null);
    };
    ServiceCoreUtilBase64Helper.prototype.decode = function (string) {
        return new Buffer(string, 'base64').toString(null, null, null);
    };
    return ServiceCoreUtilBase64Helper;
})();
var ServiceCoreUtilBufferHelper = (function () {
    function ServiceCoreUtilBufferHelper(serviceCoreUtil) {
        this._serviceCoreUtil = serviceCoreUtil;
    }
    ServiceCoreUtilBufferHelper.prototype.concat = function (buffers) {
    ...
    return ServiceCoreUtilBufferHelper;
})();
var ServiceCoreUtilStringHelper = (function () {
    function ServiceCoreUtilStringHelper(serviceCoreUtil) {
        this._serviceCoreUtil = serviceCoreUtil;
    }
    ServiceCoreUtilStringHelper.prototype.byteLength = function (str) {
    ...
    return ServiceCoreUtilStringHelper;
})();
var ServiceCoreUtilCryptoHelper = (function () {
    function ServiceCoreUtilCryptoHelper(serviceCoreUtil) {
        this.crc32Table = [
            0x00000000, 
            0x77073096, 
            0xEE0E612C, 
    ...
    ServiceCoreUtilCryptoHelper.prototype.crc32 = function (data) {
    ...
    ServiceCoreUtilCryptoHelper.prototype.hmac = function (key, string, digest, fn) {
        if(!digest) {
            digest = 'binary';
        }
        if(!fn) {
    ...
    ServiceCoreUtilCryptoHelper.prototype.md5 = function (data, digest) {
        if(!digest) {
            digest = 'binary';
        }
        if(typeof data === 'string') {
    ...
    ServiceCoreUtilCryptoHelper.prototype.sha256 = function (string, digest) {
        if(!digest) {
            digest = 'binary';
        }
    ...
    ServiceCoreUtilCryptoHelper.prototype.toHex = function (data) {
        var out = [];
        for(var i = 0; i < data.length; i++) {
    ...
    ServiceCoreUtilCryptoHelper.prototype.createHash = function (algorithm) {
        return cryptoLib.createHash(algorithm);
    };
    return ServiceCoreUtilCryptoHelper;
})();
var ServiceCoreUtilDateHelper = (function () {
    function ServiceCoreUtilDateHelper(serviceCoreUtil) {
        this._serviceCoreUtil = serviceCoreUtil;
    }
    ServiceCoreUtilDateHelper.prototype.getDate = function () {
        return new Date();
    };
    ServiceCoreUtilDateHelper.prototype.iso8601 = function (date) {
        if(date === undefined) {
            date = this.getDate();
        }
        return date.toISOString();
    };
    ServiceCoreUtilDateHelper.prototype.rfc822 = function (date) {
        if(date === undefined) {
            date = this.getDate();
        }
        return date.toUTCString();
    };
    ServiceCoreUtilDateHelper.prototype.unixTimestamp = function (date) {
        if(date === undefined) {
            date = this.getDate();
        }
        return date.getTime() / 1000;
    };
    ServiceCoreUtilDateHelper.prototype.from = function (date) {
    ...
    ServiceCoreUtilDateHelper.prototype.format = function (date, formatter) {
        if(!formatter) {
            formatter = 'iso8601';
        }
        return this[formatter](this.from(date));
    };
    return ServiceCoreUtilDateHelper;
})();
var ServiceCoreUtility = (function () {
    function ServiceCoreUtility(apiServiceCoreSettings) {
        ...
        this.base64 = new ServiceCoreUtilBase64Helper(this);
        this.buffer = new ServiceCoreUtilBufferHelper(this);
        this.string = new ServiceCoreUtilStringHelper(this);
        this.date = new ServiceCoreUtilDateHelper(this);
        this.crypto = new ServiceCoreUtilCryptoHelper(this);
    }
    ...
    ServiceCoreUtility.prototype.uriEscape = function (string) {
    ...
    ServiceCoreUtility.prototype.uriEscapePath = function (string) {
        var parts = [];
...
var ApiServiceEndpoint = (function () {
    function ApiServiceEndpoint(endpoint, util) {
...
var ApiServiceHttpRequest = (function () {
    function ApiServiceHttpRequest(endpoint, region, method, currentHeaders, data, util) {
        endpoint = new ApiServiceEndpoint(endpoint, util);
    ...
    ApiServiceHttpRequest.prototype.pathname = function () {
        return this.path.split('?', 1)[0];
    };
    ApiServiceHttpRequest.prototype.search = function () {
        return this.path.split('?', 2)[1] || '';
    };
    return ApiServiceHttpRequest;
})();
var ApiServiceCoreSettings = (function () {
    function ApiServiceCoreSettings() {
        this.Endpoint = ApiServiceEndpoint;
        this.HttpRequest = ApiServiceHttpRequest;
        this.VERSION = 'v1.0.0';
        ...
        this.util = new ServiceCoreUtility(this);
    }
    return ApiServiceCoreSettings;
})();
;
(module).exports = ApiServiceCoreSettings;
