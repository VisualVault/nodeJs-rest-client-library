...
class ServiceCoreUtilBase64Helper {
...
class ServiceCoreUtilBufferHelper {
...
class ServiceCoreUtilStringHelper {
...
class ServiceCoreUtilCryptoHelper {
...
class ServiceCoreUtilDateHelper {
...
class ServiceCoreUtility {
    ...
    base64: ServiceCoreUtilBase64Helper;

    buffer: ServiceCoreUtilBufferHelper;

    string: ServiceCoreUtilStringHelper;

    /**
     * Date and time utility functions.
     */
    date: ServiceCoreUtilDateHelper;

    crypto: ServiceCoreUtilCryptoHelper;
...
class ApiServiceHttpRequest {
    ...
    constructor(endpoint, region, method, currentHeaders, data, util: ServiceCoreUtility) {
...
class ApiServiceCoreSettings {
  ...
  HttpRequest = ApiServiceHttpRequest;
