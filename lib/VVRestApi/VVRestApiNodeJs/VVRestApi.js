(function (vvRestApi) {
    var vvClient = (function () {
        ...
        vvClient.prototype.acquireSecurityToken = function () {
            ...
            this.Q.when(this.__getToken()).then(function (response) {
        ...
        vvClient.prototype.getFormTemplates = function (params) {
        ...
        vvClient.prototype.getForms = function (params, formTemplateId) {
        ...
        vvClient.prototype.postForms = function (params, data, formTemplateId) {
            var resourceUri = this._config.ResourceUri.Forms.replace('{id}', formTemplateId);
            var url = this.__getUrl(resourceUri);
            var opts = {
                method: 'POST'
        ...
        vvClient.prototype.postFormRevision = function (params, data, formTemplateId, formId) {
            var resourceUri = this._config.ResourceUri.Forms.replace('{id}', formTemplateId);
        ...
        vvClient.prototype.getSites = function (params) {
        ...
        vvClient.prototype.postSites = function (params, data) {
        ...
        vvClient.prototype.putSites = function (params, data, siteId) {
            var resourceUri = this._config.ResourceUri.Sites;
        ...
        vvClient.prototype.getUsers = function (params, siteId) {
        ...
        vvClient.prototype.postUsers = function (params, data, siteId) {
            var resourceUri = this._config.ResourceUri.Users.replace('{id}', siteId);
            var url = this.__getUrl(resourceUri);
            var opts = {
                method: 'POST'
        ...
        vvClient.prototype.putUsers = function (params, data, siteId, usId) {
            var resourceUri = this._config.ResourceUri.Users.replace('{id}', siteId);
        ...
        vvClient.prototype.getGroups = function (params, siteId) {
        ...
        vvClient.prototype.postGroups = function (params, data, siteId) {
            var resourceUri = this._config.ResourceUri.Groups.replace('{id}', siteId);
            var url = this.__getUrl(resourceUri);
            var opts = {
                method: 'POST'
        ...
        vvClient.prototype.putGroups = function (params, data, siteId, grId) {
            var resourceUri = this._config.ResourceUri.Groups.replace('{id}', siteId);
        ...
        vvClient.prototype.getFolders = function (params) {
        ...
        vvClient.prototype.getDocuments = function (params, folderId) {
        ...
        vvClient.prototype.postEmails = function (params, data) {
        ...
        vvClient.prototype.request = function (httpVerb, url, params, data) {
            var opts = {
                method: ''
            };
        ...
        vvClient.prototype.httpGet = function (url, params, requestCallback) {
            var self = this;
            var options = {
                method: 'GET',
                uri: url,
        ...
        vvClient.prototype.httpPost = function (url, params, data, requestCallback) {
            var self = this;
            var options = {
                method: 'POST',
                uri: url,
        ...
        vvClient.prototype.httpPut = function (url, params, data, requestCallback) {
            var self = this;
            var options = {
                method: 'PUT',
                uri: url,
        ...
        vvClient.prototype.httpDelete = function (url, params, requestCallback) {
            var self = this;
            var options = {
                method: 'DELETE',
                uri: url,
        ...
        vvClient.prototype.__acquireNewTokenWithRequest = function (options, requestCallback) {
            var attemptCount = 0;
            this.Q.when(this.__getToken()).then(function () {
        ...
        vvClient.prototype.__recursiveAttemptAcquireToken = function (options, requestCallback, attemptCount) {
            this.Q.when(this.__getToken()).then(function () {
                options.qs.token = this._token;
                this.nodeJsRequest(options, function (error, response, body) {
                    requestCallback(error, response, body);
        ...
        vvClient.prototype.__doVvClientRequest = function (url, opts, params, data) {
            var self = this;
            var deferred = this.Q.defer();
        ...
        vvClient.prototype.__getUrl = function (resourceUrl) {
            return this._sessionToken.baseUrl + this._sessionToken.apiUrl + resourceUrl;
        };
        vvClient.prototype.__getToken = function () {
            var self = this;
        ...
        authorize.prototype.acquireSecurityToken = function (loginToken, developerId, developerSecret, baseUrl, apiUrl, customerAlias, databaseAlias, authenticationUrl) {
            ...
            this.Q.when(this.__getToken(loginToken, developerId, developerSecret, baseUrl, customerAlias, databaseAlias, authenticationUrl, true)).then(function (response) {
                ...
                if(typeof (response) != 'undefined' && response != null) {
                    ...
                    var api = new vvClient(sessionToken);
    ...
    (function (common) {
        ...
        var requestSigning = (function () {
            ...
            requestSigning.prototype.sign = function (headers, targetUrl, method, data, developerId, developerSecret) {
...
})(exports.vvRestApi || (exports.vvRestApi = {}));
var vvRestApi = exports.vvRestApi;
